  ...
  return (
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/colaboradores/novo" element={<PrivateRoute><ColaboradorForm /></PrivateRoute>} />
        <Route path="/colaboradores/:id" element={<PrivateRoute><ColaboradorForm /></PrivateRoute>} />
