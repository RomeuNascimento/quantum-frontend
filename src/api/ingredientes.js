...
export const converterEmEmbalagem = (id) => api.post(`/ingredientes/${id}/converter-em-embalagem`)
export const relatorioPrecosInsumos = () => api.get('/ingredientes/relatorio-precos')
